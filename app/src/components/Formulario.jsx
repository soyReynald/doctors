    ...
    return (
        <div className="md:w-1/2 lg:w-2/5">
            ...
            <form className="bg-white shadow-md rounded-lg py-10 px-5 mb-10">
                ...
                <div className="mb-5">
                    <label htmlFor="propietario" className="block text-gray-700 text-sm font-bold">
                ...
                <div className="mb-5">
                    <label htmlFor="alta" className="block text-gray-700 text-sm font-bold">
                        Alta
                    </label>
                    <input
                        id="alta"
                ...
                <div className="mb-5">
                    <label htmlFor="sintomas" className="block text-gray-700 text-sm font-bold">
                        Sintomas
                    </label>
                    <textarea
                        id="sintomas"
